...
/*
	...
	D:\Codes\DCS CODES\DCS Final codes\2> javac -cp $MPJ_HOME/lib/mpj.jar MPJUppercase.java
	D:\Codes\DCS CODES\DCS Final codes\2> $MPJ_HOME/bin/mpjrun.sh -np 4 MPJUppercase


	MPJ Express (0.44) is started in the multicore configuration
	Processor 0 has data: hello cl ix codes
	Processor 0 has data: hello
	Processor 0 is converting data to uppercase
	Processor 1 has data: cl 
	Processor 1 is converting data to uppercase
	Processor 2 has data: ix
	Processor 2 is converting data to uppercase
	Processor 3 has data: codes
